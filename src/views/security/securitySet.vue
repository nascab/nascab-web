			...
			<div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;">
				...
				<div style="display:flex;flex-direction:column;align-items: flex-start;">
					...
					<div>
						...
						<Input style="width:30px;margin-right:5px" number class="input_item" v-model="ipBan.testCount">
						</Input>
						<span style="margin-right:5px"> {{ $t('security.timesIpBlock') }} </span>
						<Input style="width:30px" number class="input_item" v-model="ipBan.banTime">
						</Input>
