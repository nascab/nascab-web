	...
	<div class="movies-root">
		...
		<div class="main-layout nas-padding-right-zero">
			...
			<div class="sidebar-mobile-root">
				<my-sidebar-mobile ref="sidebarMobile" @onItemClick="setLeftMenuId" :optionList="sideOptionList"></my-sidebar-mobile>
			</div>
			<!-- 影视列表 -->
			<div style="width: 100%;height: 100%;">
				<movie-list v-if="viewType == 'list'" ref="movieList">
				</movie-list>
				<!-- 文件夹视图 -->
...
<script>
	...
	import folder from "@/views/photos/photo-list/folder.vue"
