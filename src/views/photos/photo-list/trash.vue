<template>
	<div class="trash-root" ref="photoListRoot">
		<!-- 头部操控条 -->
		<photo-operation-header style="width:100%;height:80px;position: absolute;left: 0;z-index: 2;" ref="photoHeader"
		...
		<div style="width:100%;display:flex;height: 100%;flex-direction:row;overflow: hidden;padding-top: 80px;">
			<!-- 照片列表容器 -->
		...
		<Modal v-model="showVideoDetail" fullscreen footer-hide :closable="false">
			<video-detail propsServerType="photo" v-if="showVideoDetail" @onClose="showVideoDetail = false" ref="videoPlayer"></video-detail>
		</Modal>
